...
@HiltViewModel
class DislikeViewModel @Inject constructor(
    ...
    fun fetchEventImages(userId: Int, eventId :Int, authToken: String) {
        ...
        viewModelScope.launch(Dispatchers.Main) {
            val userDataResult = eventImageRepository.fetchEventImages(userId = userId, eventId = eventId, status = "REJECT", authToken = authToken)
